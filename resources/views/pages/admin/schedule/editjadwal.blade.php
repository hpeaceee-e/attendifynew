                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="abbreviation"
                                                            name="abbreviation" value="{{$schedules->Singkatan}}" required>
                                                        @error('abbreviation')
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <select class="form-control" name="day[]" id="" required>
                                                                <option value="Senin" {{ $d->days == 'Senin' ? 'selected' : '' }}>Senin</option>
                                                                <option value="Selasa" {{ $d->days == 'Selasa' ? 'selected' : '' }}>Selasa</option>
                                                                <option value="Rabu" {{ $d->days == 'Rabu' ? 'selected' : '' }}>Rabu</option>
                                                                <option value="Kamis" {{ $d->days == 'Kamis' ? 'selected' : '' }}>Kamis</option>
                                                                <option value="Jumat" {{ $d->days == 'Jumat' ? 'selected' : '' }}>Jumat</option>
                                                            </select>
                                                        </div>
                                                    </div>
